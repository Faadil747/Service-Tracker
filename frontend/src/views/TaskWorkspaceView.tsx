                                ...
                                {pendingTasks.map(t => (
                                    <div key={t.id} className="glass-card" style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: 12 }}>
                                        ...
                                        <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end', flexWrap: 'wrap' }}>
                                            ...
                                            <button className="btn btn-sm" style={{ background: 'rgba(16,185,129,0.15)', color: 'var(--success)', border: '1px solid rgba(16,185,129,0.3)' }} onClick={() => handleApproveTask(t.id, 'approved', reviewComments[t.id], false)}>
                                                ✓ Approve
                                            </button>
                                            {t.post && (
                                                <button className="btn btn-sm btn-primary" style={{ display: 'flex', alignItems: 'center', gap: 4 }} onClick={() => handleApproveTask(t.id, 'approved', reviewComments[t.id], true)}>
                                                    🚀 Approve &amp; Publish
                                                </button>
                                            )}
                                        </div>
